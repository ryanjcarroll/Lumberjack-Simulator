...
class BackpackInventoryMenu:
    def __init__(self, game):
        ...
        # draw menu
        self.width = BACKPACK_TILE_SIZE * BACKPACK_ROW_CAPACITY
        self.height = BACKPACK_TILE_SIZE * BACKPACK_NUM_ROWS
    ...
    def draw(self, screen):
        ...
        square_size = self.width // BACKPACK_ROW_CAPACITY # Calculate size of each square
        for row in range(BACKPACK_NUM_ROWS):
            for col in range(BACKPACK_ROW_CAPACITY):
                index = col + (row*BACKPACK_ROW_CAPACITY)
                x = col * square_size
                y = row * square_size
...
class CampInventoryMenu:
    def __init__(self, game):
        ...
        self.y = WINDOW_HEIGHT - self.height - CAMP_MENU_PADDING - BACKPACK_MENU_PADDING - (BACKPACK_TILE_SIZE*BACKPACK_NUM_ROWS) # Top padding of 10 pixels
